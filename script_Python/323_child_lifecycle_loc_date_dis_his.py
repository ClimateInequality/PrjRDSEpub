...
# df = date_or_age_category_exist_share(df, id_vars, month_age_or_history='month_mics6_to_history', start_month=start_month, end_month=end_month, df_store=df_store, A=f'dis_intensity_{dis_intensity_type}', B=f'date_m{start_month}to{end_month}', C=f'dis_{dis_intensity_type}_DB_m{start_month}to{end_month}', D=f'dis_{dis_intensity_type}_DS_m{start_month}to{end_month}')
...
start_month = -9
end_month = 24
df_store = date_or_age_category_exist_share(df, id_vars, month_age_or_history='age_month_mics6_to_history', start_month=start_month, end_month=end_month, df_store=df_store, A=f'dis_intensity_{dis_intensity_type}', B=f'life_g{start_month}to{end_month}', C=f'dis_{dis_intensity_type}_DB_g{start_month}to{end_month}', D=f'dis_{dis_intensity_type}_DS_g{start_month}to{end_month}')
...
def fn_dis_var(df, id_vars, month_history, start_m, end_m, age_in_month, start_g, end_g, df_store, A, B, C, D):
    '''
    Description
    -----------
    ...
    df[B] = None
    # df.loc[(start_month <= df[month_age_or_history]) & (df[month_age_or_history] <= end_month), B] = 1
    df[B][(start_m <= df[month_history]) & (df[month_history] <= end_m) & (start_g <= df[age_in_month]) & (df[age_in_month] <= end_g)] = 1   # This should work faster than above line 
...
df_store = fn_dis_var(df, id_vars, month_history='month_mics6_to_history', start_m=start_m, end_m=end_m, age_in_month='age_month_mics6_to_history', start_g=start_g, end_g=end_g, df_store=df_store, A=f'dis_intensity_{dis_intensity_type}', B=f'life_g{start_g}_to_m{start_m}', C=f'dis_{dis_intensity_type}_DB_g{start_g}_to_m{start_m}', D=f'dis_{dis_intensity_type}_DS_g{start_g}_to_m{start_m}')
