...
if bl_test is True: 
    ...
    dir_csv_file = f'{dir_data}/data_to_est/child_lifecycle_loc_date_alltype_n{it_sample}_{st_run_computer}_DM.csv'
    
else:
    df_YZ = pd.read_csv(f'{dir_data}/data_intermediate/YZ_child_lifecycle_skeleton.csv')
    dir_csv_file = f'{dir_data}/data_to_est/child_lifecycle_loc_date_alltype_full_{st_run_computer}_DM.csv'
