...
if bl_test is True: 
    ...
    dir_csv_file = f'{dir_data}/data_to_est/child_lifecycle_loc_date_alltype_n{it_sample}_{st_run_computer}_DB_DS_Add_m1to12.csv'
    
else:
    df_YZ = pd.read_csv(f'{dir_data}/data_intermediate/YZ_child_lifecycle_skeleton.csv')
    dir_csv_file = f'{dir_data}/data_to_est/child_lifecycle_loc_date_alltype_full_{st_run_computer}_DB_DS_Add_m1to12.csv'
...
for key in range(3, 8):  # Adjust the range as needed
