...
log using "$dir_log\230_mics_child_$today.log", replace



********************************************************************************
* merge　all variables for child human capital 
********************************************************************************
...
do 230_mics_child_kid
do 230_mics_child_edu
do 230_mics_child_test


u "$dir_tempdata\230_mics_child_kid", clear
merge 1:1 countryfile HH1 HH2 LN using "$dir_tempdata\230_mics_child_edu"
drop _merge 
merge 1:1 countryfile HH1 HH2 LN using "$dir_tempdata\230_mics_child_test"
drop _merge 

sort countryfile HH1 HH2 LN ISO_alpha_3
order RDSE_loc_id countryfile HH1 HH2 LN moLN faLN ISO_alpha_3, first 

sa "$dir_data\\data_intermediate\\230_mics_child", replace

// erase "$dir_tempdata\230_mics_child_kid.dta"
// erase "$dir_tempdata\230_mics_child_edu.dta"
// erase "$dir_tempdata\230_mics_child_test.dta"
...
sa "$dir_data\\data_intermediate\230_mics_child_WithRawVar", replace

export delimited using "$dir_data\data_intermediate\230_mics_child_WithRawVar.csv", nolabel replace
// export delimited using "$dir_main\data_pivot_table\230_mics_child.csv", nolabel replace
